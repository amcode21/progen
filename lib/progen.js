...
const options = require('yargs')
                .command('create', 'create new project template in directory', (yargs) => {
                    return yargs.options({
                        'out-dir': {
                            alias: 'o',
                            demandOption: true,
                            describe: 'path to create new template - default is current directory',
                            default: process.cwd(),
                            type: 'string'
                        },
                        'verbose': {
...
module.exports = () => {
    inquirer.prompt(questions)
        .then((answers) => {
            ...
            buildTemplateDirectory(process.cwd(), null, template);
